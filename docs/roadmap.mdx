---
title: Roadmap
description: What's coming next for Codeplane
---

# Roadmap

Codeplane is constantly evolving. Here is a look at what we are currently building and what is planned for the future.

## Shipped & Feature Complete

The core Codeplane platform is available in our closed alpha, providing:
...
- **TypeScript Workflows:** Unified AI and CI definitions (`.codeplane/workflows`).
...
A first-class capability to run your TypeScript-defined `.codeplane/workflows` entirely on your local machine. Test CI steps, run agent evaluations, and debug complex pipelines locally without needing to push to the cloud.
...
Native integration with [Smithers](https://smithers.sh) for managing autonomous, 24/7 running agents directly inside your Codeplane repositories.
